...
export async function checkIfMinimalMandatarisInfoAvailable(
  ...
  if (typedResult.length) {
    ...
    await createNotification({
      ...
      description:
        'Een Mandataris uit het Besluit heeft niet alle minimale informatie. Een Mandataris in een Besluit moet minstens een startdatum, een persoon en een mandaat bevatten. Het mandaat moet gekend zijn bij ABB.',
      type: 'error',
      graph,
      links: [
        {
